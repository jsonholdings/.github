# GitHub org settings — jsonholdings

Draft for the orchestrator/owner to apply via the GitHub org Settings UI (or `gh api
orgs/jsonholdings` with a token that has `admin:org`). Not applied by this session.

- **Display name:** JSON Holdings
